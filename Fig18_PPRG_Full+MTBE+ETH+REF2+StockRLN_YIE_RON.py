### Fig17: PPRG-Full + stock_RLN (20%) + ETH 5% + ETH 10% + REF2 25% (when hits ARO at 25%) : stock remaing LN (considering 30% divert to ISO)
...
MTBE_in_Gasoline = 5/100  ; ETH_in_Gasoline  = 10/100
REF2_in_Gasoline = 22/100 
...
ax1.plot(SC,gasolineSC,color='red', label='Full PPRG + 20% StockRLN + MTBE 5% + ETH 10% + REF 22%', marker='x')
ax2.plot(SC,gasolineSCRON,color='blue',label='Full PPRG + 20% StockRLN + MTBE 5% + ETH 10% + REF 22%',linestyle='dashed', marker='x')
...
#ax1.legend()
#ax2.legend()
text = ax1.text(-1.26,55.71, "|", fontsize=13)
