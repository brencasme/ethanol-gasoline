### Fig7: PPRG-Full + MTBE 5%, 10% and 15%
...
MTBE_in_Gasoline = 5/100  ; ETH_in_Gasoline  = 0/100 #10%
...
ax1.plot(SC,gasolineSC,color='red', label='Full PPRG + MTBE 5%', marker='x')
ax2.plot(SC,gasolineSCRON,color='blue',label='Full PPRG + MTBE 5%',linestyle='dashed', marker='x')

# Supply Chain (SC) or Exogenous Variables

MTBE_in_Gasoline = 10/100  ; ETH_in_Gasoline  = 0/100 #10%
REF2_in_Gasoline = 0/100 #10%
total  = MTBE_in_Gasoline + ETH_in_Gasoline + REF2_in_Gasoline
...
ax1.plot(SC,gasolineSC,color='red', label='Full PPRG + MTBE 10%', marker='o')
ax2.plot(SC,gasolineSCRON,color='blue',label='Full PPRG + MTBE 10%',linestyle='dashed', marker='o')

# Supply Chain (SC) or Exogenous Variables

MTBE_in_Gasoline = 15/100  ; ETH_in_Gasoline  = 0/100 #10%
REF2_in_Gasoline = 0/100 #10%
total  = MTBE_in_Gasoline + ETH_in_Gasoline + REF2_in_Gasoline
...
ax1.plot(SC,gasolineSC,color='red', label='Full PPRG + MTBE 15%', marker='s')
ax2.plot(SC,gasolineSCRON,color='blue',label='Full PPRG + MTBE 15%',linestyle='dashed', marker='s')
...
#ax1.legend()
#ax2.legend()
text = ax1.text(-1.4,46.80, "|", fontsize=13)
