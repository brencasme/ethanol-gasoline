...
ax1.plot(SC,gasolineSC,color='red', label='Full PPRG + MTBE 5% + ETH 10%', marker='x')
ax2.plot(SC,gasolineSCRON,color='blue',label='Full PPRG + MTBE 5% + ETH 10%',linestyle='dashed', marker='x')
...
#ax1.legend()
#ax2.legend()
text = ax1.text(-1.42,44.45, "|", fontsize=13)
