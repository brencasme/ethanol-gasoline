### Fig13: PPRG-Full + MTBE 5% + ETH 10% + REF2(25%) (when hits ARO at 25%)
...
MTBE_in_Gasoline = 5/100  ; ETH_in_Gasoline  = 10/100 #10%
REF2_in_Gasoline = 25/100 #10%
...
ax1.plot(SC,gasolineSC,color='red', label='Full PPRG + MTBE 5% + ETH 10% + REF2 25%', marker='x')
ax2.plot(SC,gasolineSCRON,color='blue',label='Full PPRG + MTBE 5% + ETH 10% + REF2 25%',linestyle='dashed', marker='x')
...
#ax1.legend()
#ax2.legend()
text = ax1.text(-1.42,60.9, "|", fontsize=13)
